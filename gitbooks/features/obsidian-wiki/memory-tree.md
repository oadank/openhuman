...
Embeddings and summary-tree building can run **on-device via Ollama** if you turn on [Local AI](../model-routing/local-ai.md); otherwise they route through the BYO provider configured under **Settings → AI**.
