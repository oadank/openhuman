...
const skillsSlice = createSlice({
  ...
  reducers: {
    addSkill(
      state,
      action: PayloadAction<{ manifest: SkillManifest }>,
    ) {
    ...
    setSkillStatus(
      state,
      action: PayloadAction<{ skillId: string; status: SkillStatus }>,
    ) {
    ...
    setSkillSetupComplete(
      state,
      action: PayloadAction<{ skillId: string; complete: boolean }>,
    ) {
    ...
    setSkillTools(
      state,
      action: PayloadAction<{ skillId: string; tools: SkillToolDefinition[] }>,
    ) {
