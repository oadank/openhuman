...
describe("shouldCaptureSession", () => {
  ...
  it("should return true for sessions with enough content", () => {
    ...
    const longText1 = "Please help me understand how the memory system works in this application. I need to know about indexing, chunking, and search. Can you walk me through the full pipeline from file read to indexed chunks stored in SQLite?";
    const longText2 = "Can you explain the hybrid search algorithm in more detail? How does it combine FTS5 and vector similarity? What are the default weights and how does the scoring merge work? I want to understand the full ranking pipeline.";
    const messages: Message[] = [
